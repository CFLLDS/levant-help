...
Source for the customer-facing help site for the Levant portal and Energy Confidence tools.
...
- no real resident names, addresses, phone numbers or case details, in text or in screenshots
- no staff email addresses
- no internal notes, test findings or supplier names that partners do not need

Screenshots come from a sandbox household with invented details only.
